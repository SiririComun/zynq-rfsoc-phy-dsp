...
################################################################
# This is a generated script based on design: acquisition_system
#
...
# source acquisition_system_script.tcl
...
set design_name acquisition_system
...
user.org:user:axis_packetizer:1.0\
...
\
  ...
  set axis_packetizer_0 [ create_bd_cell -type ip -vlnv user.org:user:axis_packetizer:1.0 axis_packetizer_0 ]
  ...
  connect_bd_intf_net -intf_net axis_packetizer_0_m_axis [get_bd_intf_pins axis_packetizer_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net xadc_wiz_0_M_AXIS [get_bd_intf_pins xadc_wiz_0/M_AXIS] [get_bd_intf_pins axis_packetizer_0/s_axis]
  ...
  [get_bd_pins axis_packetizer_0/clk] \
  ...
  [get_bd_pins axis_packetizer_0/reset_n]
