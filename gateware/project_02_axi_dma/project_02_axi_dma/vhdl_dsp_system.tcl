...
################################################################
# This is a generated script based on design: dma_subsystem
#
...
# source dma_subsystem_script.tcl
...
user.org:user:stream_scaler:1.0\
"
...
\
  ...
  # Create instance: stream_scaler_0, and set properties
  set stream_scaler_0 [ create_bd_cell -type ip -vlnv user.org:user:stream_scaler:1.0 stream_scaler_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins stream_scaler_0/s_axis]
  ...
  connect_bd_intf_net -intf_net stream_scaler_0_m_axis [get_bd_intf_pins stream_scaler_0/m_axis] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  [get_bd_pins stream_scaler_0/clk]
  ...
  [get_bd_pins stream_scaler_0/reset_n]
